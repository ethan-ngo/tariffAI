...
.cart-item {
  ...
  box-shadow: 0 6px 32px 0 rgba(40,40,60,0.25), 0 1.5px 6px 0 rgba(0,0,0,0.10);
  transition: box-shadow 0.2s, background 0.2s, transform 0.13s;
  border: 1.5px solid #292933;
}
.cart-item:hover {
  box-shadow: 0 8px 40px 0 rgba(60,60,80,0.32), 0 2px 8px 0 rgba(0,0,0,0.13);
  background: linear-gradient(135deg, #282832 80%, #353545 100%);
...
.item-qty button:not(:disabled):hover {
  background: #282832;
}
.item-qty span {
  min-width: 22px;
